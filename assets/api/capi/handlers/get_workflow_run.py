...
def index_handler(event, context):
    """Handler for the GET of one or all airflow workflow runs of a DAG.

    This endpoint is a proxy to the airflow
    /api/v2/dags/{dag_id}/dagRuns/{dag_run_id} endpoint. Done as a
    ...
    try:
        ...
        if qsp is None:
            ...
            if None in [dag_id, dag_run_id]:
                ...
                api_path = f"/dags/{dag_id}/dagRuns/{dag_run_id}"
